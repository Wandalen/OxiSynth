...
impl Synth
{
   ...
   */
  pub fn set_gen(&mut self, chan : usize, param : GeneratorType, value : f32) -> Result<(), OxiError>
  {
   ...
   */
  pub fn gen(&self, chan : u8, param : GeneratorType) -> Result<f32, OxiError> { self.handle.gen(chan, param) }
}
