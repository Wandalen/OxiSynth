use crate::{utils::RangeCheck, OxiError};
...
pub enum MidiEvent
{
  ...
  PitchBend
  {
    channel : u8, value : U14
  },
  /// Send a program change message.
  ProgramChange
  {
    channel : u8, program_id : U7
  },
...
#[test]
fn uuu7() { let event = MidiEvent::NoteOff { channel : 0, key : 15 }; }
