...
impl Synth
{
   ...
   */
  pub fn remove_font(&mut self, id : TypedIndex<SoundFont>, reset_presets : bool) -> Result<(), ()>
  {
   ...
   */
  pub fn count_fonts(&self) -> usize { self.font_bank.count() }
   ...
   */
  pub fn nth_font(&self, num : usize) -> Option<&SoundFont> { self.font_bank.get_nth_font(num) }

  /**
  Get a SoundFont. The SoundFont is specified by its ID.
   */
  pub fn sfont(&self, id : TypedIndex<SoundFont>) -> Option<&SoundFont> { self.font_bank.get_font(id) }
}
