...
{
  fn default() -> Self { Self::FourthOrder }
}
...
impl Channel
{
  ...
  pub fn sfontnum(&self) -> Option<TypedIndex<SoundFont>> { self.sfontnum }

  pub fn set_sfontnum(&mut self, sfontnum : Option<TypedIndex<SoundFont>>) { self.sfontnum = sfontnum; }

  //

  pub fn banknum(&self) -> u32 { self.banknum }

  pub fn set_banknum(&mut self, banknum : u32) { self.banknum = banknum; }

  //

  pub fn prognum(&self) -> u8 { self.prognum }

  pub fn set_prognum(&mut self, prognum : u8) { self.prognum = prognum; }

  //

  pub fn preset(&self) -> Option<&Rc<Preset>> { self.preset.as_ref() }

  pub fn set_preset(&mut self, preset : Option<Rc<Preset>>) { self.preset = preset; }

  //

  pub fn key_pressure(&self, id : usize) -> i8 { self.key_pressure[id] }

  pub fn set_key_pressure(&mut self, id : usize, val : i8) { self.key_pressure[id] = val; }

  //

  pub fn channel_pressure(&self) -> u8 { self.channel_pressure }

  pub fn set_channel_pressure(&mut self, val : u8) { self.channel_pressure = val; }

  //

  pub fn pitch_bend(&self) -> i16 { self.pitch_bend }

  pub fn set_pitch_bend(&mut self, val : i16) { self.pitch_bend = val; }

  //

  pub fn pitch_wheel_sensitivity(&self) -> u8 { self.pitch_wheel_sensitivity }

  pub fn set_pitch_wheel_sensitivity(&mut self, val : u8) { self.pitch_wheel_sensitivity = val; }
  ...
  pub fn cc_mut(&mut self, id : usize) -> &mut u8 { &mut self.cc[id] }

  //

  pub fn bank_msb(&self) -> u8 { self.bank_msb }

  pub fn set_bank_msb(&mut self, val : u8) { self.bank_msb = val; }

  //

  pub fn interp_method(&self) -> InterpolationMethod { self.interp_method }

  pub fn set_interp_method(&mut self, new_method : InterpolationMethod) { self.interp_method = new_method; }

  //

  pub fn tuning(&self) -> Option<&Tuning> { self.tuning.as_ref() }

  pub fn set_tuning(&mut self, val : Option<Tuning>) { self.tuning = val; }

  //

  pub fn nrpn_select(&self) -> i16 { self.nrpn_select }

  pub fn set_nrpn_select(&mut self, value : i16) { self.nrpn_select = value; }

  //

  pub fn nrpn_active(&self) -> i16 { self.nrpn_active }

  pub fn set_nrpn_active(&mut self, value : i16) { self.nrpn_active = value; }

  //

  pub fn gen(&self, id : usize) -> f32 { self.gen[id] }

  pub fn set_gen(&mut self, id : usize, val : f32) { self.gen[id] = val; }

  //

  pub fn gen_abs(&self, id : usize) -> i8 { self.gen_abs[id] }

  pub fn set_gen_abs(&mut self, id : usize, val : i8) { self.gen_abs[id] = val; }
}
